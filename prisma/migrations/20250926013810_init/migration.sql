-- CreateEnum
CREATE TYPE "public"."Status" AS ENUM ('RECEIVED', 'IN_DIAGNOSIS', 'WAITING_APPROVAL', 'IN_EXECUTION', 'FINISHED', 'DELIVERED', 'CANCELLED');
...
-- AddForeignKey
ALTER TABLE "public"."WorkOrderPartOrSupply" ADD CONSTRAINT "WorkOrderPartOrSupply_workOrderId_fkey" FOREIGN KEY ("workOrderId") REFERENCES "public"."WorkOrder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."WorkOrderPartOrSupply" ADD CONSTRAINT "WorkOrderPartOrSupply_partOrSupplyId_fkey" FOREIGN KEY ("partOrSupplyId") REFERENCES "public"."PartOrSupply"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."WorkOrderService" ADD CONSTRAINT "WorkOrderService_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "public"."Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
